...
module.exports = {
    name: 'ouch',
    description: 'Neg vouch a user.',
    usage: 'ouch <@user> {reason}',
    execute(message, args, prefix) {
        // Check if the command is used in the specified ouch channel
        ...
        const ouchEmbed = new Discord.MessageEmbed()
            ...
            .setDescription(`Successfully Negvouched for ${mentionedUser.tag} ${reason ? `with reason: ${reason}` : ''}`);
